...
public:
    ...
    {
        RunTimeWindow->setWindowTitle(QApplication::translate("RunTimeWindow", "Running Status", Q_NULLPTR));
        pushButtonStop->setText(QApplication::translate("RunTimeWindow", "Stop Simulation", Q_NULLPTR));
        ShowDetails->setText(QApplication::translate("RunTimeWindow", "Show details", Q_NULLPTR));
    } // retranslateUi

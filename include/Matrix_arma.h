...
public:
    ...
    CMatrix_arma diag_mat();
    CMatrix_arma max(double &x);
    CMatrix_arma min(double &x);
...
CMatrix_arma diag_mat(const CMatrix_arma &M);
CMatrix_arma max(CMatrix_arma &M, double &x);
CMatrix_arma min(CMatrix_arma &M, double &x);
